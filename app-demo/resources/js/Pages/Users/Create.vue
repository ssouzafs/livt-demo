<template>
  <Layout>
    ...
    <form class="max-w-xl mx-auto my-8" @submit.prevent="submit">
      <div class="mb-6">
        <label class="block mb-2 font-light text-sm text-gray-700" for="name">
          Nome:
        </label>
        <input
          id="name"
          ...
          :class="
            form.errors.name
              ? 'border-red-500 focus:ring focus: ring ring-red-200'
              : 'border-indigo-500'
          "
      ...
      <div class="mb-6">
        <label class="block mb-2 font-light text-sm text-gray-700" for="email">
          E-mail:
        </label>
        <input
          id="email"
